<template>
    <div id="C018-01" class="container-fluid p-3 h-100 w-100">
        <div id="C018-01-01" class="container-fluid p-3 h-100 w-100 shadow-sm board" style="margin-top:20pt;">
            <div class="row">
                <div class="col-12">
                    <button id="C018-01-01-01" class="btn btn-primary" style="font-size:15pt;width:150pt" v-on:click="onClickChangeTerm()" v-html="buttonCaptionSelectTerm"></button>
                    <div id="C018-01-01-02" class="d-inline-block" style="color:#000000;font-size:15pt; margin-left: 20px; vertical-align: middle;" v-html="targetTerm"></div>
                </div>
            </div>
        </div>
        <div id="C018-01-02" class="container-fluid p-3 h-100 w-100 shadow-sm board" style="margin-top:20pt;">
            <div class="row">
                <div class="col-12">
                    <button id="C018-01-02-01" class="btn btn-primary" style="font-size:15pt;width:150pt" v-on:click="onClickChangeEmployee()" v-html="buttonCaptionSelectEmployee"></button>
                    <div id="C018-01-02-02" class="d-inline-block" style="color:#000000;font-size:15pt; margin-left: 20px; vertical-align: middle;" v-html="targetEmployee"></div>
                </div>
            </div>
        </div>
        <div id="C018-01-03" class="container-fluid p-3 h-100 w-100 shadow-sm board" style="margin-top:20pt;">
            <div class="row">
                <div class="col-12">
                    <button id="C018-01-03-01" class="btn btn-primary" style="font-size:15pt;width:150pt" v-bind:disabled="!isSelected" v-on:click="showList()">一覧表示</button>
                    <button class="btn btn-primary" v-on:click="downloadReport('#C018-01-03-02')" v-bind:disabled="!isSelected">CSV出力 <i class="fas fa-download fa-2x"></i></button>
                    <VueJsonToCsv :json-data="csvBuff" :csv-title="csvFileName" :labels="labelBuff">
                        <button id="C018-01-03-02" style="display: none;" v-on:click="getReport('C018-01-03-02')"></button>
                    </VueJsonToCsv>
                    <div id="C018-01-03-03" class="d-inline-block" style="color:#000000;font-size:15pt; margin-left: 20px; vertical-align: middle;">一覧表示もしくはCSV出力を選択してください</div>
                    <button id="C018-01-03-04" class="btn btn-primary float-right" style="font-size:15pt;width:150pt" v-bind:disabled="!isSelected" v-on:click="clearList">表示クリア</button>
                </div>
            </div>
        </div>
        <div id="C018-01-04" class="container-fluid p-3 h-100 w-100 shadow-sm board" style="margin-top:20pt;" v-if="isViewList">
            <div class="row">
...
export default {
    ...
    data() {
        return {
            ...
            modalOption_m109: {
                callback_select_m109: (Employee)=>{this.callback_select_m109(Employee);},
                callback_cancel_m109: ()=>{this.callback_cancel_m109();},
                employeeID: 0,
            },
            modalOption_m112: {
                message: '',
    ...
    methods: {
        ...
        {
            this.modalOption_m109.employeeID = this.employeeID;
            //モーダルを開く
