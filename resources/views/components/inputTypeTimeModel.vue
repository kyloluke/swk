...
<script>
export default {
    name: "inputTypeTimeModel",
    model:{
        prop: 'timeSerial',
        event: 'changeTimeSerial',
    },
    props: {
        timeSerial: {
            type: Number,
    ...
    methods:{
        onInputChagedHoure: function(){
            ...
            this.$emit("changeTimeSerial", this.timeSerialSum);
        },
    ...
    computed:{
        timeSerialSum(){
            ...
            else if(this.input_hour == "" || this.input_minute == "")
            {
                return -1;
            }
