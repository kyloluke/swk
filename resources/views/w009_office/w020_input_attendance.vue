...
<template>
    <div id="C020-01" class="container-fluid p-3 h-100 w-100">
        <div id="C020-01-02" class="container-fluid p-3 h-100 w-100 shadow-sm board" style="margin-top:20pt;">
            <div class="row">
                <div class="px-2">
                    <div id="C020-01-01-01" class="text-left">
                        対象者選択
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="px-3 col-2 text-left">
                    <button id="C020-01-01-02" style="font-size:11pt;width:100pt" class="btn btn-primary" v-bind:disabled="isSelectedTarget" v-on:click="selectTarget()">対象者検索</button>
                </div>
                <div class="px-3 col-8 text-left">
                    <div id="C020-01-01-04" style="font-size:15pt;color:black;" v-html="TextSelectTarget"></div>
                </div>
                <div class="px-3 col-2 text-center">
                    <button id="C020-01-01-05" style="font-size:11pt;width:100pt" class="btn btn-primary" v-bind:disabled="!isSelectedTarget" v-on:click="exitInput()">入力終了</button>
                </div>
            </div>
        </div>
